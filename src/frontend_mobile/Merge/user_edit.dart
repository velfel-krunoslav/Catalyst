          ...
          child: Container(
            ...
            child: Column(
              children: [
                          ...
                          child: TextFormField(
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  setState(() {
                                    textFieldHeight[0] = BUTTON_HEIGHT + 20 + 20;
                                  });
                ...
                SizedBox(height: 20),
                isLoading ? CircularProgressIndicator() : ButtonFill(
                  text: 'Primeni',
                  onPressed: () {
                    if (_formKey2.currentState.validate()) {
                      ...
                      if (_image != null) {
                        asyncFileUpload(_image).then((value) {
                          ...
                          usersModel.editUser(usr.id, imageUrl, desc, email, phoneNumber, address).then((v) {
                        ...
                        usersModel.editUser(usr.id, usr.photoUrl, desc, email, phoneNumber, address).then((v) {
                          User user = User(id: usr.id,
                              name: usr.name,
                              surname: usr.surname,
                              privateKey: usr.privateKey,
