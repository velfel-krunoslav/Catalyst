...
Widget HomeDrawer(
    ...
    dynamic Function(int id) getUserById, Function(User u) editUserCallback) {
    ...
    DrawerOption(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => MyAccount(user: user, editUserCallback: editUserCallback)));
        },
