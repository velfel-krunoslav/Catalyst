...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    for(int i = 0; i < product.assetUrls.length; i++){
      images.add(product.assetUrls[i]);
    }
                          ...
                          child: ButtonFill(
                              ...
                              onPressed: () {
                                ...
                                if (_formKey.currentState.validate() &&
                                    ...
                                    isSetUnit &&
                                    isSetImages) {
                                  Classification classif = getClassification(selectedUnit);
                                  ProductEntry p  = ProductEntry(
                                    ...
                                    desc: description,
                                    assetUrls: ["https://ipfs.io/ipfs/QmVB38abDTVj5FU1GTbW6k2QhDB8FHxYqhBHwFTrix78Bw"],
                                    quantifier: quantity,
                                    classification: classif,
                                    inStock: inStock
                                  );
                                  widget.editProductCallback(p);
                                  widget.refreshCallback(p);
                                  Navigator.pop(context);
                                }
                              }),
                        ),
