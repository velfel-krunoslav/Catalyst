                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text('2.40 $CURRENCY', style: TextStyle(fontFamily: 'Inter', fontSize: 16, color: Color(DARK_GREY))),
                          SizedBox(height: 20),
                          Row(
                        ...
                        child: ButtonOutline(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                            MaterialPageRoute(
                                builder: (context) => new Scaffold(body: Center(child: Text('Porudžbina potvrđena'),))));
                          },
                        ),
                      ),
                      Spacer(),
                        ...
                        child: ButtonOutline(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => new Scaffold(body: Center(child: Text('Porudžbina otkazana'),))));
                          },
                        ),
                      ),
                    ],
