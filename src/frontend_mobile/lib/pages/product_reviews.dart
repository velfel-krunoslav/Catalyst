  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        body: reviewsModel.isLoading ? LinearProgressIndicator(backgroundColor: Colors.grey,) : SafeArea(
          child: Center(
            child: Container(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        Wrap(
                          children: List.generate(reviewsModel.average.round(), (index) {
                            return SvgPicture.asset("assets/icons/StarFilled.svg", color: Colors.yellow[700]);
                          }),
                        ),
                        Wrap(
                          children: List.generate(5 - reviewsModel.average.round(), (index) {
